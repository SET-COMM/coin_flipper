...
document.addEventListener('DOMContentLoaded', function () {
    // Add event listeners and handlers for Flip buttons
    document.getElementById('flip').addEventListener('click', () => {
        ...
        if (flippedHeads) {
            ...
            document.getElementById('msg').textContent = 'You Flipped Heads!'
            ...
            document.getElementById('msg').textContent = 'You Flipped Tails!'
    ...
    // Add event listeners and handlers for clear button
    document.getElementById('clear').addEventListener('click', function () {
        ...
        document.getElementById('msg').textContent = 'Let\'s Get Rolling!'
